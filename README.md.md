...
![Battle Early](assets/ss-battle-early.png)
...
![Battle Late](assets/ss-battle-late.png)
...
![Winner Overlay](assets/ss-winner.png)
...
![Debrief Screen](assets/ss-debrief.png)
...
| **6 Strategies** | `AGGRESSIVE` `DEFENSIVE` `CONTROL` `FLANK` `RECON` `RETREAT` — auto-selected every 60 ticks based on battlefield state |
...
│   ├── ss-boot.png         # Boot screen screenshot
│   ├── ss-briefing.png     # Briefing screen screenshot
│   ├── ss-battle-early.png # Battle HUD — early game
│   ├── ss-battle-late.png  # Battle HUD — late game
│   ├── ss-winner.png       # Victory overlay screenshot
│   └── ss-debrief.png      # Debrief screen screenshot
│
└── README.md
```
